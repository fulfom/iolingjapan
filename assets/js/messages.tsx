...
export const emails = <div className="simple-box">
    ...
    <Accordion flush>
        ...
        <Accordion.Item eventKey="2">
            <Accordion.Header as="p">2025/12/29 8:00頃: JOL2026競技会場ページ公開</Accordion.Header>
            <Accordion.Body>
                <p className="mb-3">JOL2026応募者のみなさま，</p>
                <p className="mb-3">JOL2026本番で使う競技会場ページを公開いたしました．</p>
                <p>競技会場ページで待機の上，問題pdfが閲覧できるようになったら各自解き始めてください．</p>
                <p className="mb-3">配信にタイムラグがあることを踏まえて，12:59～13:00の間に配信します．</p>
                <p className="mb-3"><a href="https://iolingjapan.org/contest/jol2026/contest/">https://iolingjapan.org/contest/jol2026/contest/</a></p>
                <p className="mb-3">※ログインが必要です．ログインしてもアクセスできない場合，メールアドレスを間違えている可能性があります．その場合は，このメールを受け取ったメールアドレスでログインしなおしてみてください．</p>
                <p className="mb-3">2点重要な注意事項をお知らせします．</p>
                <p><strong>不正行為について</strong></p>
                <p>不正行為は偽計業務妨害にあたり，違法行為です．</p>
        ...
        <Accordion.Item eventKey="0">
            <Accordion.Header as="p">2025/12/22: 日本言語学オリンピック JOL2026事前準備ページ公開 & 今後のスケジュール</Accordion.Header>
            <Accordion.Body>
                <p className="mb-3">JOL2026応募者のみなさま，</p>
                <p className="mb-3">このたびは日本言語学オリンピックにご応募いただきありがとうございます．</p>
                <p className="mb-3">今後のスケジュールについてご連絡いたします．</p>
                <ul className="mb-3">
                    <li>12月22日「JOL2026事前準備」ページ公開</li>
                    <li>12月22日～29日 動作確認期間</li>
                    <li>12月29日 「JOL2026競技会場」ページ公開</li>
                </ul>
                <p className="mb-3">まず，本日公開の「JOL2026事前準備」ページでは，当日とほとんど同じ環境で競技の体験ができるようになっています．具体的には1. 問題（体験版）pdfの閲覧，2. 解答の入力（スプレッドシートまたはエクセル），3. 競技中の質問投稿・訂正の確認，4. 当日の流れと注意事項の説明，以上4点が可能です．</p>
                <p>ごくまれに問題が閲覧できないなどのトラブルがありますので，あらかじめ事前準備ページにアクセスしていただき，動作確認と練習を行っていただくようお願いいたします．</p>
                <p className="mb-3">事前準備ページ: <a href="https://iolingjapan.org/contest/jol2026/demo/">https://iolingjapan.org/contest/jol2026/demo/</a></p>
                <p className="mb-3">※ログインが必要です．ログインしてもアクセスできない場合，メールアドレスを間違えている可能性があります．その場合は，このメールを受け取ったメールアドレスでログインしなおしてみてください．※事前練習ページにはログイン後に開く「応募者ページ」からもアクセス可能です．</p>
                <p className="mb-3">29日になりましたら，「JOL2026競技会場」ページが公開されます．12時30分～競技開始までの間にこちらのページにアクセスしてください．13:00になりましたら競技がスタートし，問題pdfの閲覧と解答入力が可能になります．2時間楽しんでいただければ幸いです．</p>
                <p className="mb-3">15:00になりましたら，競技終了・解散となります．結果は競技3週間後をめどに発表する予定です．</p>
                <p className="mb-3">解答入力の方法など，細かい点は事前練習ページに記載の案内をご確認ください．</p>
                <p className="mb-3">それでは，よろしくお願いいたします．</p>
                <p>国際言語学オリンピック日本委員会</p>
