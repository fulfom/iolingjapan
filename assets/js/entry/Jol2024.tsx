    ...
    useLayoutEffect(() => {
        ...
        auth.onAuthStateChanged(async v => {
            ...
            if (v) {
                ...
                const dbOrderRef = ref(db, "/orders/jol2024/" + v.email!.replace(/\./g, '='));
                    ...
                    if (snapshotOrder.val()) {
                        ...
                        if (udbtmp && udbtmp.email || udb && udb.email) {
                            if (udbtmp && !udbtmp.entry || udb && !udb.entry) {
                                update(ref(db, "/contests/jol2024/users/" + v.uid), { entry: true })
                            };
                            setStep(3);
                            setLoaded(true);
                            off(dbOrderRef);
            ...
            {loaded && user ? <>
                ...
                {step === 0 ? <div>
                    ...
                    <button onClick={() => {
                        setStep(1);
                        window.scrollTo(0, 0);
                    }} className="btn btn-template-primary">JOL2024応募に進む</button>
                    ...
                    <button onClick={async () => {
                        update(await ref(db, "/contests/jol2024/users/" + user.uid), { isNotNew: true });
                        ...
                        >
                            ...
                            {udb.spot === "flag" ? <>
                                ...
                                <Form.Group className="mb-3 was-validated" controlId="formPa">
                                    <Form.Check required type="checkbox" label="JOL2024への参加にあたって私は保護者に有効な同意を得ています"
                ...
                {step === 3 || step === 4 || step === 13 ? <div>
                    ...
                    <div className="simple-box">
                        ...
                        <p>JOL2024の応募に使用したメールアドレス: {user.email}</p>
                    </div>
