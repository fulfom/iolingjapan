                    ...
                    if (snapshotOrder.val()) {
                        ...
                        if (udbtmp && udbtmp.email || udb && udb.email) {
                            if (udbtmp && !udbtmp.entry || udb && !udb.entry) {
                                update(ref(db, "/contests/jol2025/users/" + v.uid), { entry: true })
                            };
                            setStep(3);
                            setLoaded(true);
                            off(dbOrderRef);
            ...
            {loaded && user ? <>
                ...
                {step === 0 ? <div>
                    ...
                    <button onClick={() => {
                        setStep(1);
                        window.scrollTo(0, 0);
                    }} className="btn btn-template-primary">JOL2025応募に進む</button>
                    ...
                    <button onClick={async () => {
                        await update(ref(db, "/contests/jol2025/users/" + user.uid), { isNotNew: true });
                        ...
                        >
                            ...
                            {udb.spot === "flag" ? <>
                                ...
                                <Form.Group className="mb-3 was-validated" controlId="formPa">
                                    <Form.Check required type="checkbox" label="JOL2025への参加にあたって私は保護者に有効な同意を得ています"
                ...
                {step === 2 ? <div>
                    ...
                    <p><a className='btn btn-template-primary text-decoration-none' href="https://iolingjapan.stores.jp/items/66decfc4c34702024900b9f8" target="_blank">受験料支払い用のサイトへ</a></p>
                    <div className="simple-box">
                ...
                {step === 3 || step === 4 || step === 13 ? <div>
                    ...
                    <div className="simple-box">
                        ...
                        <p>JOL2025の応募に使用したメールアドレス: {user.email}</p>
                    </div>
