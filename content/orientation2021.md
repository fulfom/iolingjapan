...
##### 8. 見つけた規則のメモ
規則の説明はAPLOやIOLでは採点されます．出題者たちが問いたいのは，いかにうまく規則を見つけ，説明できるかというテクニック．設問も，規則がきちんと見つけられたかを試せるように作られています．ですから発見した規則を整理しておくことは必然的に，設問を解く上で役に立ちます．ミスを減らしたり未分析のデータから情報を得たり．JOLでは規則の説明そのものは点数になりませんが，手元のメモなどにきちんとまとめておくと良いでしょう．
...
| a-  彼は | li- ～した     | jenga 建てる  |
{{< /table>}}
のようなメモをしておくと，次に tulisafari のようなデータが出てきたとき，tuは主語を，safariは動詞を表す部分だと判断できるようになります．    
