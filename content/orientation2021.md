...
試験の詳細は下記の[JOLの応募方法](#jolの応募方法)および[受験案内2021](https://iolingjapan.org/application/)をご確認ください。
...
<iframe src="https://www.facebook.com/plugins/video.php?height=314&href=https%3A%2F%2Fwww.facebook.com%2Finternational.linguistics.olympiad%2Fvideos%2F653567755048784%2F&show_text=false&width=560" width="100%" height="314" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowFullScreen="true"></iframe>
こちらは2017年のダブリン大会の動画です。
<iframe width="100%" height="314" src="https://www.youtube.com/embed/KeThEGttUBU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
1. [受験案内2021](https://iolingjapan.org/application/)を読み、ページ下部の「応募はこちら」のボタンなどから[ログインぺージ](https://iolingjapan.org/account/)に進みます。
{{< figure src="/img/orientation2021/image1.png" title="" >}}
2. [利用規約](https://iolingjapan.org/term-of-service/)と[プライバシーポリシー](https://iolingjapan.org/privacy-policy/)を読み、Googleアカウントまたはメールアドレスでログインします
{{< figure src="/img/orentation2021/image2.png" title="" >}}
...
2. 次に受験料の支払いをします。ページ下部の「受験料の支払いに進む」ボタンを押して[受験料支払いページ](https://iolingjapan.stores.jp/items/5f8bb7180850a00ec7c6a0bd)に移動します。カートに入れて注文画面に進み、お客様情報を入力します。このお客様情報のメールアドレスが支払いの確認に利用されます。「[受験者情報](https://iolingjapan.org/account/)」に登録されているものと同じメールアドレスを使用するようにしてください。
{{< figure src="/img/orientation2021/image5.png" >}}
また、ここで入力した住所が賞状の発送の際に利用される予定です。JOL終了後に受賞者が[受験者情報](https://iolingjapan.org/account/)で住所を確認・変更できるようにする予定です。
3. お支払い方法を選び、必要な情報を入力します。手数料などについては[受験案内2021](https://iolingjapan.org/application/#23-%E5%8F%97%E9%A8%93%E6%96%99)を参照してください。
4. 内容を確認し、完了します。Storesから購入完了メールが届いたことを確認してください。このメールが領収書の代わりとなります。当委員会からは登録・応募が完了したことを通知するメールは送信されません。
5. 当委員会が受験料の支払いを確認すると、受験者情報の「受験料の支払い」に緑色のチェックアイコンが表示されます。反映には時間がかかります。支払い完了から3日経っても表示が更新されない場合は当委員会にお知らせください。二重に受験料を支払うことの無いようにしてください。

## 競技の流れ

## 国際大会体験談

こんにちは、2019年度代表です。私は高校2年の3月にJOLに参加し、高校3年の夏にIOLに参加しました。この章では私が出場したヨンイン大会のようすを紹介します。   
以下の記述は今年度とは大きく異なる部分があると思いますがご了承ください。<br><br>
...
公式の練習会のほかにも、1~2週間に1度くらい非公式の練習会を開催していただきました。    
...
APLO 2019の問題は[こちら](https://aplo.asia/problems-by-year/)から。
...
また、[IOL2019特設ページ](https://iolingjapan.org/iol2019/)には大会期間中のスケジュールやきれいな写真が載っています。一緒にご覧ください。
...
{{< figure src="/img/orientation2021/dormitory.jpg" >}}
...
{{< figure src="/img/orientation2021/truth_peace_creativity.jpg" >}}  

ご飯は大学の食堂で作ってもらったものを食べました。本当に金属の箸を使っていて感動しました。   
{{< figure src="/img/orientation2021/meal1.jpg" >}} 
...
{{< figure src="/img/orientation2021/neighborhood.jpg" >}}
...
これはお土産の訓民正音（ハングル制定時に本（木箱入り））。

{{< figure src="/img/orientation2021/hunminjeongeum" >}}
...
私は日本の代表と一緒に大学内のカラオケルームに引きこもって歌っていたら他の代表のかたが入ってきてくれたので一緒に歌ったりしました。     
