...
<!--超簡単な問題。予備知識があると解きやすくなるやつだとよい-->

このように、言語学オリンピックの問題は与えられたデータ（＋一般常識）のみから解答できるように構成されています。    
語学力・言語学の知識など、**事前知識は必須ではありません**。

ただし、知識が問題を解くうえで役に立つこともよくあります。
上の問題でも、<!--予備知識で殴れることもあるよって話-->


#### 対策方法
<!--スキルのほう-->
スキルは問題を解くことで鍛えられます。[過去問・資料まとめ](/preparation)から問題を選んで解いたり、有志で運営されている[ことはじ](https://kotohazi.netlify.app/problems/)を利用して問題を探したりできます。ことはじではジャンルや難易度などから問題を検索することができます。    
後述のテクニックも参照しながら、できるだけ正答を見ず考え抜くのがおすすめです。

<!--知識のほう 本？wikipedia読むっていうの公式で勧めて良いのかわからない-->
...
そういうときも無理やりなにか作業をしていると頭の中が整理されていくことがあります。上に挙げたテクニックのうちまだ試していないものをやったりするのがおすすめです。1点でも多く点が取れるようにもがきましょう。    
