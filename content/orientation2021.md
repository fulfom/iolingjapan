...
などを知っていると，分析が楽になったり，発見した答えに自信を持てます．
...
点字一文字（縦3*横2）がひらがな一文字に対応していることが分かれば残りの文字も特定できます．  
...
データがそろっているイ段に注目します．イ段の文字は全て左上と左中が埋まっていており，この部分が母音 i を表していると考えられます．   
逆に，「き」「し」「ち」からここを除いた部分，つまり左下，右中，右下が行の違いを表していると分かります．    
...
##### 頻度解析
あるなしクイズの双子のようなテクニックで，ひとつひとつのデータの意味などがどう対応しているか分からないような場合に役に立つ手法です．    

---

##### 見つけた規則のメモ
発見した規則はどこかにメモしておきましょう．これはAPLOやIOLでは採点されますが，JOLでは求められません．  
しかし，これを書いておくことでミスを減らしたり未分析のデータから情報を得ることができます．    
...
のようなものが出てきたときに、tuは主語を、safariは動詞を表す部分だと判断することができるようになります。    
