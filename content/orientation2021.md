...
正常に試験を受けられるか確認するためデモを行います。

#### 3. 本番
JOLは12/28（土）にオンラインで実施されます。

##### 3.1 筆記試験
試験は13:00から15:00までの2時間です。13:00になったら[受験者情報](/account)で問題のpdfと解答用紙へのリンクをお知らせします。   
解答用紙はGoogleスプレッドシートを使用します。解答は自動で保存され、解答終了時刻になった時点でのシートの状態が解答として記録されます。

##### 3.2 面接
筆記試験の結果に基づき、およそ*銅賞ボーダー以上*の*選抜参加者*のかたを対象にZoomで面接を実施します。    
