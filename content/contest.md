...
<!-- 選抜参加者のみ，ここに面接関連のアナウンスを出す．個人の開始時間と，入出時間，入出リンク，入出リンクの QRコード（スマホで読み取る用） -->

{{< simplebox "面接のお知らせ">}}
あなたは面接対象者です．    
あなたの面接は16:20に始まります．10分前の16:10に面接会場のzoomミーティングで待機していてください．    
面接会場には[こちら]()から，または下のQRコードからアクセスできます．    
<img src="/img/orientation2021/QR.png">
{{< /simplebox >}}
...
{{< figure src="/img/orientation2021/interview.png">}}
